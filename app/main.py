...
class Config:
    _DEFAULTS = {
        ...
        'OUTPUT_TEMPLATE_CHAPTER': '%(title)s [%(id)s] - %(section_number)02d - %(section_title)s.%(ext)s',
        'OUTPUT_TEMPLATE_PLAYLIST': '%(playlist_title)s/%(title)s [%(id)s].%(ext)s',
        'OUTPUT_TEMPLATE_CHANNEL': '%(channel)s/%(title)s [%(id)s].%(ext)s',
